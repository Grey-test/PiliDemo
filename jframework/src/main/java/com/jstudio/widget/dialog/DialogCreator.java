...
public class DialogCreator {
    ...
    public static Dialog createProgressDialog(Context context, Position position, int color, String message, boolean cancellable) {
        ...
        switch (position) {
            case BOTTOM:
                style = R.style.BottomDialog;
                view = LayoutInflater.from(context).inflate(R.layout.jfw_dialog_progress_material, null, false);
                break;
            case CENTER:
                style = R.style.CenterDialog;
                view = LayoutInflater.from(context).inflate(R.layout.jfw_dialog_center_progress, null, false);
                break;
            case TOP:
                style = R.style.TopDialog;
                view = LayoutInflater.from(context).inflate(R.layout.jfw_dialog_progress_material, null, false);
    ...
    public static Dialog createNoDimProgressDialog(Context context, String message) {
        View view = LayoutInflater.from(context).inflate(R.layout.jfw_dialog_no_dim, null, false);
        MaterialProgressBar progressBar = (MaterialProgressBar) view.findViewById(R.id.progress);
